function traerInformacion(){
	$.ajax({    
    url : 'http://129.151.123.218/api/Motorbike/all',
    type : 'GET',
    dataType : 'json',
...
function guardarInformacion(){
	...
	if (selected.length > 0) {
		...
		$.ajax(    
		'http://129.151.123.218/api/Motorbike/save',
		{data: datosJson,
		type : 'POST',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://129.151.123.218/api/Motorbike/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
  
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://129.151.123.218/api/Motorbike/"+id);
        let miTabla = '<table>';
...
function actualizarInformacion(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
    'http://129.151.123.218/api/Motorbike/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function pintarSelect(id){
	$.ajax({    
    url : 'http://129.151.123.218/api/Category/all',
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
